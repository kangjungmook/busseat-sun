              ...
              child: Column(
                children: [
                  ...
                  Text(
                    ...
                    // 설정의 '계산 근거 자세히 보기'가 실제로 붙는 자리.
                    // 켜면 이 답이 어느 태양 위치에서 나왔는지를 숫자로 보여준다.
                    state.showCalcDetail
                        ? '태양 ${comp.azimuthLong} · 고도 ${comp.altitudeDeg.round()}° · '
                            '${comp.timeLabel} 기준 · 직사광 기준(건물 그림자 미반영) · ${comp.spanLabel} 구간'
