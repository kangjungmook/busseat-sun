                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        if (adv != null) Text(comp!.isNight ? '—' : '${adv.pct}%', style: TextStyle(fontFamily: AppTextStyles.family, fontSize: 12.5, fontWeight: FontWeight.w800, color: palette.primaryText)),
                      ],
                    ),
                  ),
                ],
                  ...
                  child: fav == null
                      ...
                      : Column(
                          ...
                          children: [
                            ...
                            Text(comp!.isNight ? '해가 진\n뒤예요' : '${adv.sideLabel}\n창가', style: TextStyle(fontFamily: AppTextStyles.family, fontSize: 17, fontWeight: FontWeight.w800, height: 1.15, letterSpacing: -.5, color: palette.text)),
                            Text(comp.isNight ? '좌우 차이 없음' : '${adv.pct}${state.effectiveMode == SunMode.shade ? '% 그늘' : '% 볕'} · 3분 후', style: TextStyle(fontFamily: AppTextStyles.family, fontSize: 10.5, fontWeight: FontWeight.w700, color: palette.primaryText)),
                          ],
                        ),
                ),
