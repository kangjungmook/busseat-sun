...
- **❗ TAGO는 서울을 담당하지 않습니다 (2026-09-08 확정).** `getCtyCodeList` 전체
  응답(5,946바이트)을 내려받아 도시명을 직접 확인한 결과 **"서울"이 없습니다.**
  목록은 오름차순 `12, 21, 22, 23, 24, 25, 26, 39, 31010, 31020…`으로 시작하며
  `11`도 없습니다. 서울 시내버스는 서울시가 따로 운영합니다(TOPIS / 서울 열린데이터광장).
